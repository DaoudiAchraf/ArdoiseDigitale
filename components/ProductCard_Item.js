...
const ProductCard_item = (props) => {
  ...
  const navTo_productDetails = ()=>{
    if(typeof(_id)=== 'object')
      props.navigation.navigate('ProductDetails',{..._id,quantity,ViewOnly:true});
    else
      props.navigation.navigate('ProductDetails',{...props.product,ViewOnly:true});
  }
