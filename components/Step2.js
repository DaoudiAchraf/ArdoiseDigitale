  ...
  return (
    <View style={styles.step_container}>
      <Text style={{ textAlign: "justify", marginBottom: 40 }}>
        Nous avons besoin de verifier votre numero de telephone vous allez
        recevoir un code de verification par SMS sur le numero 123 456 789
        .Veuillez entrer ce code dans le champs ci-dessous. Pour renvoyer le
        code, cliquez ici
      </Text>
      ...
      <View>
        ...
        <Input value={code} handleChange={setCode} />
