...
const { clientRegisterValidation, clientLoginValidation } = require ('../middlwares/validation')
...
router.post('/login', async(req, res, next) => {
    ...
    .then((clt) => {
            ...
            const isValid = utils.validPassword(req.body.password, clt.hash, clt.salt);
